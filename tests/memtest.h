...
#define MEMORY_TRACE_AFTER(OP)                                                                                         \
    {                                                                                                                  \
        trace_status(&blocks_after, &size_after);                                                                      \
        CU_ASSERT(blocks_before OP blocks_after);                                                                      \
        CU_ASSERT(size_before OP size_after);                                                                          \
    }
#define MEMORY_TRACE_AFTER_EQ                                                                                          \
    {                                                                                                                  \
        trace_status(&blocks_after, &size_after);                                                                      \
        CU_ASSERT_EQUAL(blocks_before, blocks_after);                                                                  \
        CU_ASSERT_EQUAL(size_before, size_after);                                                                      \
    }
#else
