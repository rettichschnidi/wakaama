...
function(target_sources_coap target)
    target_sources(
        ${target} PRIVATE ${WAKAAMA_TOP_LEVEL_DIRECTORY}/coap/block.c
                          ${WAKAAMA_TOP_LEVEL_DIRECTORY}/coap/er-coap-13/er-coap-13.c
...
function(target_sources_wakaama target)
    ...
    get_target_property(EXISTING_TARGET_COMPILE_DEFINITIONS ${target} COMPILE_DEFINITIONS)

    if(NOT EXISTING_TARGET_COMPILE_DEFINITIONS MATCHES "LWM2M_LITTLE_ENDIAN|LWM2M_BIG_ENDIAN")
    ...
    if(NOT EXISTING_TARGET_COMPILE_DEFINITIONS MATCHES "LWM2M_COAP_DEFAULT_BLOCK_SIZE=")
    ...
    if(NOT EXISTING_TARGET_COMPILE_DEFINITIONS MATCHES "LWM2M_SERVER_MODE|LWM2M_BOOTSTRAP_SERVER_MODE|LWM2M_CLIENT_MODE")
...
function(target_sources_shared target)
    ...
    target_sources(
        ${target}
        PRIVATE ${WAKAAMA_EXAMPLE_SHARED_DIRECTORY}/commandline.c
                ${WAKAAMA_EXAMPLE_SHARED_DIRECTORY}/memtrace.c
    ...
    elseif(TARGET_PROPERTY_DTLS MATCHES "tinydtls")
        ...
        target_sources(
            ${target} PRIVATE ${TINYDTLS_SOURCES} ${WAKAAMA_EXAMPLE_SHARED_DIRECTORY}/dtlsconnection.c
        )
