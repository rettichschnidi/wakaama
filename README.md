...
Several preprocessor definitions are supported:
 ...
 - Per default, LWM2M version 1.1. is supported. Limiting support to previous versions is possible:
   - LWM2M_VERSION_1_0 to support only version 1.0
   Please note: Clients support only the specified version, while servers also support previous ones.
